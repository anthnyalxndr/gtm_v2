...
export type SpecSection =
  "folder" | "variable" | "trigger" | "tag" | "client" | "transformation" | "builtInVariable";
...
export const SECTIONS_BY_CONTAINER_TYPE: Readonly<Record<ContainerType, readonly SpecSection[]>> = {
  web: ["folder", "variable", "trigger", "tag", "builtInVariable"],
  server: ["folder", "variable", "trigger", "tag", "client", "transformation", "builtInVariable"],
