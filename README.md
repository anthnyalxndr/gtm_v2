...
| `@anthnyalxndr/gtm-apply` | Declarative apply tool and `gtm-apply` CLI. Describe a container in the shape of a GTM export, plan, and reconcile by name. Depends on `gtm-client`. | [packages/gtm-apply](packages/gtm-apply/README.md) |
